...
export default function List() {
  ...
  const columns = useMemo(
    () => [
      ...
      {
        accessorFn: (row) => row.partial_days,
        id: "partial_days",
        header: "Partial Days",
  ...
  const fetchData = useCallback(async () => {
    ...
    const { data } = await axios.post(
      API_URL +
        `/api/master/partial_days/serverside?${filterParams}&page=${pagination.pageIndex}&size=${pagination.pageSize}&sort=${sort}`,
      {},
      {
        headers: {
        ...
        <div className="max-w-full mx-auto sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="px-4 py-3 border-b flex items-center gap-2">
              ...
              <h2 className="text-lg font-semibold">Master Partial Days</h2>
            </div>
