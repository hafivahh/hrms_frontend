...
import { FileInput, Paper, Group, Loader, Button, Text, Table } from "@mantine/core";
import { IconFileSpreadsheet, IconUpload, IconDownload, IconX } from "@tabler/icons-react";
...
const handleSubmit = async () => {
  ...
  if (!allowedTypes.includes(templateFile.type)) {
    showAlert("Invalid File", "error", "Template must be an Excel file (.xls / .xlsx)");
    return;
  }
